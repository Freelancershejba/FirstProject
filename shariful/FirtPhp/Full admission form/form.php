    ...
    <form method="POST" action="" onSubmit="return vld()">
        ...
        if (isset($_POST["submit"])) {
            ...
            if ($er == 0) {
                ...
                $userName = 'root';
                $password = '';
                $databaseName = 'admissioin_form';
                $success = '<span class="G_alert">Data insert successfully PHP!</span>';

                $cn = mysqli_connect($host, $userName, $password, $databaseName);

                $sql = "insert into student_info(student_name, father_name, mother_name, roll, registration, phone_number, distric) values(
                    '" . mysqli_real_escape_string($cn, $studentName) . "',
                    '" . mysqli_real_escape_string($cn, $fatherName) . "',
                    '" . mysqli_real_escape_string($cn, $motherName) . "',
                    '" . mysqli_real_escape_string($cn, $roll) . "',
                    '" . mysqli_real_escape_string($cn, $registration) . "',
                    '" . mysqli_real_escape_string($cn, $phoneNumber) . "',
                    '" . mysqli_real_escape_string($cn, $distric) . "')";

                // '" . strip_tags($studentName) . "',
                // '" . strip_tags($fatherName) . "',
                // '" . strip_tags($motherName) . "',
                // '" . strip_tags($roll) . "',
                // '" . strip_tags($registration) . "',
        ...
        <div class="mb-3">
            ...
            <input type="name" name="studentName" class="form-control" placeholder="Enter your name" value="<?php echo $studentName; ?>" value="<?php echo $studentName; ?>" id="studentName" aria-describedby="emailHelp">
            <span id="EstudentName"><?php echo $EstudentName; ?></span>
        </div>
        <div class="mb-3">
            <lebel for="fatherName" class="form-lebel sm">Father Name</lebel>
            <input type="name" name="fatherName" class="form-control" placeholder="Enter your father name" value="<?php echo $fatherName; ?>" id="fatherName" aria-describedby="emailHelp">
            <span id="EfatherName"><?php echo $EfatherName; ?></span>
        </div>
        <div class="mb-3">
            <lebel for="motherName" class="form-lebel sm">Mother Name</lebel>
            <input type="name" name="motherName" class="form-control" placeholder="Enter your mother name" value="<?php echo $motherName; ?>" id="motherName" aria-describedby="emailHelp">
            <span id="EmotherName"><?php echo $EmotherName; ?></span>
        </div>
        <div class="mb-3">
            <lebel for="roll" class="form-lebel sm">Roll No</lebel>
            <input type="number" name="roll" class="form-control" placeholder="Enter your roll number" value="<?php echo $roll; ?>" id="roll" aria-describedby="emailHelp">
            <span id="Eroll"><?php echo $Eroll; ?></span>
        </div>
        <div class="mb-3">
            <lebel for="registration" class="form-lebel sm">Registration No</lebel>
            <input type="number" name="registration" class="form-control" placeholder="Enter your registration number" value="<?php echo $registration; ?>" id="registration" aria-describedby="emailHelp">
            <span id="Eregistration"><?php echo $Eregistration; ?></span>
        </div>
        <div class="mb-3">
            <lebel for="phoneNumber" class="form-lebel sm">Phone Number</lebel>
            <input type="number" name="phoneNumber" class="form-control" placeholder="Enter your phone number" value="<?php echo $phoneNumber; ?>" id="phoneNumber" aria-describedby="emailHelp">
            <span id="EphoneNumber"><?php echo $EphoneNumber; ?></span>
        </div>
        <div class="mb-3">
            <lebel for="phoneNumber" class="form-lebel sm">Distric</lebel>
            <select class="form-select" aria-label="Default select example" name="distric" id="distric" value="<?php echo $distric; ?>">
